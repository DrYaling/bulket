...
enum class EAnimNotifyType : uint8 {
	None UMETA(Hidden),
	/**
	 * Prev Animation End(optional)
	 */
	PrevAnimEnd,
	/**
	 * Prev teminate Animation state End(optional)
	 */
	PreTerminateEnd,
	/**
	* Skill Cast State End
	*/
	SkillCastingEnd,
	/**
	* skill combo state end(optional)
	*/
	SkillComboEnd,
	/**
	* skill finish
	*/
	SkillFinish,
	/**
	* skill damage state, check hit in this state duration(optional)
	*/
	SkillDamageCheck,
};
...
public:
	...
	/**
	* skill asset for this notify
	*/
	UPROPERTY()
		TObjectPtr<class USkillAsset> SkillInstance;
private:
	/**
