...
ARustPawn::ARustPawn()
{
	...
	//MovementCom = CreateDefaultSubobject<UAIMovementComponent>(TEXT("MovementCom"));
	//MovementCom->MoveComponentFlags = EMoveComponentFlags::MOVECOMP_NeverIgnoreBlockingOverlaps;
