...
using SetActorLocationAndRotationFn = bool(*)(const AActorOpaque* Actor, Vector3 LocationOrRotation, bool SetLocation, HitResult* SweepResult, ETeleportType Teleport);
...
struct ActorFns {
    ...
    SetActorLocationAndRotationFn set_location_rotation;
};
...
struct SkillKeyBinding {
    int32 skill_id;
    EGameInputType key;
};
using GamePlaySetUnitSkills = void (*)(int32, SkillKeyBinding*, int32);
struct RustBindings {
    ...
    GamePlaySetUnitSkills set_unit_skills;
...
extern "C" {
    ...
    bool SetActorLocationAndRotation(const AActorOpaque* Actor, Vector3 LocationOrRotation, bool SetLocation, HitResult* SweepResult, ETeleportType Teleport);
} // extern "C"
